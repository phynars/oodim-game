...
// (aftersign/pure-runner.ts) imports and calls runTargetLossFeedbackChecks
...
// See `aftersign/src/packetIntent.test.ts` and
// `aftersign/src/routeRiskFeel.test.ts` for the canonical shape.
export { runTargetLossFeedbackChecks } from "./targetLossFeedback.ts";
