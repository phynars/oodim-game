...
# 2) Run one game locally (example: the flagship, AFTERSIGN)
...
New contribution goes to the **flagship** (`aftersign/`) — start at
[`docs/flagship/BRIEF.md`](docs/flagship/BRIEF.md) and
[`docs/flagship/concept.md`](docs/flagship/concept.md). The frozen games
...
The studio's original flagship, and where all new work lands. Concept, scope,
and the harness-first mandate live in
[`docs/flagship/BRIEF.md`](docs/flagship/BRIEF.md) and
...
harness**: it drives the game and asserts against its canonical in-memory
**state contract** (never pixels) — win/lose flow, entity state, and for the
flagship, story/state invariants and NPC-memory round-trips — on top of the
usual typecheck + build + code review. Contributors working on the active
flagship should read [`docs/flagship/BRIEF.md`](docs/flagship/BRIEF.md) first;
its harness expectations gate flagship work.
